//===- config_gemm_rs_sm90_H800_tp4_nnodes1.cu ------------------------- C++ ---===//
//
...
static int config_gemm_rs_sm90_h800_tp4_nnodes1 = []() {
  ...
  inst.add(make_gemm_meta(_FP16{}(),_Sm90{}(),_H800{}(),_ReduceScatter{}(),_RCR{}(),_GemmV3{}(),None{},make_reduce_scatter_meta(false,_IntraNode{}())),make_runtime_config(8192,12288,12288,make_reduce_scatter_runtime_config(4,1)),make_gemm_hparams(make_gemm_v3_hparams(cute::make_tuple(2l,1l,1l)),None{},cute::make_tuple(128l,256l,64l),_GemmDefault{}(),0,_RasterHeuristic{}()));
  inst.add(make_gemm_meta(make_gemm_dtype_config(_S8{}(),_S8{}(),_BF16{}(),_BF16{}(),_S32{}()),_Sm90{}(),_H800{}(),_ReduceScatter{}(),_RCR{}(),_GemmV3{}(),make_gemm_v3_meta(false),make_reduce_scatter_meta(false,_IntraNode{}())),make_runtime_config(4096,5120,1280,make_reduce_scatter_runtime_config(4,1)),make_gemm_hparams(make_gemm_v3_hparams(cute::make_tuple(2l,1l,1l),_PingPong{}()),None{},cute::make_tuple(64l,128l,128l),_GemmDefault{}(),4,_RasterAlongM{}()));
  inst.add(make_gemm_meta(make_gemm_dtype_config(_S8{}(),_S8{}(),_Void{}(),_BF16{}(),_S32{}()),_Sm90{}(),_H800{}(),_ReduceScatter{}(),_RCR{}(),_GemmV3{}(),make_gemm_v3_meta(false),make_reduce_scatter_meta(false,_IntraNode{}())),make_runtime_config(4096,5120,1280,make_reduce_scatter_runtime_config(4,1)),make_gemm_hparams(make_gemm_v3_hparams(cute::make_tuple(2l,1l,1l),_PingPong{}()),None{},cute::make_tuple(64l,128l,128l),_GemmDefault{}(),4,_RasterAlongM{}()));
  inst.add(
    make_gemm_meta(
        make_gemm_dtype_config(_E4M3{}(), _E4M3{}(), _Void{}(), _BF16{}(), _FP32{}()),
        _Sm90{}(),
        _H800{}(),
        _ReduceScatter{}(),
        _RCR{}(),
        _GemmV3{}(),
        make_gemm_v3_meta(false),
        make_reduce_scatter_meta(false, _IntraNode{}())),
    make_runtime_config(4096, 5120, 5120, make_reduce_scatter_runtime_config(4, 1)),
    make_gemm_hparams(
        make_gemm_v3_hparams(cute::make_tuple(2l, 1l, 1l), _PingPong{}()),
        None{},
        cute::make_tuple(64l, 128l, 128l),
        _GemmDefault{}(),
        0,
        _RasterHeuristic{}()));
  return 0;
